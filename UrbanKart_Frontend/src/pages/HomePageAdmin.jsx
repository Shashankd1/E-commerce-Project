...
function HomePageAdmin() {
  ...
  const ShowProducts = () => {
    return (
      <>
        <div className="buttons text-center py-5 mb-5 "  style={{backgroundColor:"#000000", borderRadius:"3rem"}}>
        ...
        {filter.map((product) => {
          return (
            <div id={product.id} key={product.id} className="col-md-3 col-sm-6 col-xs-8 col-12 mb-4">
              <div className="card text-center h-100" key={product.id} style={{ border: '1px solid #000' }}>
                <img
